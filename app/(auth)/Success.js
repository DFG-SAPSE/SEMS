  ...
  return (
    <View style={styles.container}>
      <View style={styles.subConatiner}>
        <Text style={styles.text}>You have successfully created an enterprise!</Text>
        <FontAwesome name="check-circle" size={150} color="green" />
      </View>
      <View style={styles.subConatiner}>
        <Text style={styles.subtext}>You can create projects within your enterprise, and see all sorts of data!</Text>
        <Button
